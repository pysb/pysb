...
class OdeView(collections.Sequence):
    ...
    # reset_equations is called). Now the "empty" condition is when
    # stoichiometry_matrix is None.

    def __init__(self, model):
        self.model = model

    def __getitem__(self, key):
        if self.model.stoichiometry_matrix is None:
    ...
    def __len__(self):
        if self.model.stoichiometry_matrix is None:
            return 0
        return self.model.stoichiometry_matrix.shape[0]
