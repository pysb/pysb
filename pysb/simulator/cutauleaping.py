...
class CuTauLeapingSimulator(Simulator):
    ...
    **kwargs: dict, optional
    ...
    def __init__(self, model, tspan=None, initials=None, param_values=None,
        ...
        super(CuTauLeapingSimulator, self).__init__(model, tspan=tspan,
                                               initials=initials,
    ...
    def run(self, tspan=None, initials=None, param_values=None, number_sim=1,
        ...
        _cutauleaping_infiles_dir = os.path.join(self.outdir, "INPUT")
        ...
        # ./cuTauLeaping input_model_folder n_parallel_threads
        # blocks gpu_number offset_of_gpu output_folder simulation_
        # fitness_calculation
        ...
        end_time = time.time()
        self._logger.info("cuTauLeaping + I/O time: {} seconds".format(end_time -
                                                                  start_time))
        return SimulationResult(self, tout, trajectories)
    ...
    def _create_gpu_init(self, initials):
        ...
        species_matrix = np.zeros((self._total_threads, self._len_species),
                                  dtype=np.int32)
    ...
    def _create_input_files(self, directory):
        ...
        with open(os.path.join(directory, "MX_0"), 'w') as MX_0:
            ...
            mx0 = self._create_gpu_init(self.initials)
    ...
    def _get_cmatrix(self):
        ...
        c_matrix = np.zeros((self._total_threads, self._len_rxns))
